...
use Insead\MIMBundle\Tests\Mock\TaskMock;
...
class SubtaskTest extends TestCase
{
    ...
    private function setEmailAttr(Subtask &$subtask){
        $subtask->setId(99999);
        $subtask->setEmailSendTo("jefferson.martin@insead.edu");
    ...
    public function testEmailSendTo() {
        ...
        $this->assertEquals($subtask->getEmailSendTo(), "jefferson.martin@insead.edu");
    }
