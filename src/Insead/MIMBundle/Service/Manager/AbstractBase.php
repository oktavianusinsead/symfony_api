...
use Insead\MIMBundle\Entity\Base as BaseEntity;
...
Use Insead\MIMBundle\MIMBundle;
/***
 * Class AbstractBase
...
abstract class AbstractBase
{
    ...
    public static $MIM_ADMIN_ROLES    = ['Staff', 'Faculty', 'INSEAD Contractor'];
    public static $MIM_ADMIN_ROLES_ID = [9, 7, 98];

    public function __construct(protected RedisBase $redisMainObj, LoggerInterface $logger, StudyNotify $notify, EntityManager $em, ValidatorInterface $validator, SerializerInterface $serializer, Backup $backup)
    {
        $this->logger               = $logger;
        $this->notify               = $notify;
