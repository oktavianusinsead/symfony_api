...
namespace Insead\MIMBundle\Service\File;
...
use \Insead\MIMBundle\Service\Manager\Base as baseServiceManager;
...
class Base
{
    ...
    public function __construct(array $config, LoggerInterface $logger, StudyNotify $notify, EntityManager $em, S3ObjectManager $s3Object, baseServiceManager $baseServiceManager)
    {
        $this->logger = $logger;
        $this->config = $config;
        $this->notify = $notify;
