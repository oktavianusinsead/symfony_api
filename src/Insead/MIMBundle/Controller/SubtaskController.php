...
class SubtaskController extends BaseController
{
    ...
    public function createSubtaskAction(Request $request, StudyNotify $studyNotify, StudyCourseBackup $studyCourseBackup)
    {
    ...
    public function updateSubtaskAction(Request $request, $subtaskId, StudyNotify $studyNotify)
    {
        $this->setLogUuid($request);
    ...
    public function deleteSubtaskAction(Request $request, $subtaskId, StudyNotify $studyNotify, StudyCourseBackup $studyCourseBackup)
    {
        $this->setLogUuid($request);
