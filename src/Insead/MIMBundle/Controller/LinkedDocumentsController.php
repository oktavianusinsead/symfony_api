...
class LinkedDocumentsController extends BaseController
{
    ...
    public function createLinkedDocAction(Request $request, StudyNotify $studyNotify)
    {
    ...
    public function updateLinkedDocAction(Request $request, $linkedDocId, StudyNotify $studyNotify)
    {
        $this->setLogUuid($request);
    ...
    public function deleteLinkedDocAction(Request $request, $linkedDocId, StudyNotify $studyNotify)
    {
        $this->setLogUuid($request);
