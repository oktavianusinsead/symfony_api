...
class FileDocumentController extends BaseController
{
    ...
    public function uploadFileDocumentAction(Request $request, edotNotify $edotNotify, edotCourseBackup $edotCourseBackup)
    {
        $this->setLogUuid($request);
    ...
    public function updateFileDocumentAction( Request $request, edotNotify $edotNotify, edotCourseBackup $edotCourseBackup)
    {
        $this->setLogUuid($request);
    ...
    #[OA\Response(
        response: 200,
        description: "Handler function to update FileDocument")]
    public function deleteFileDocumentAction(Request $request, $id, edotNotify $edotNotify, edotCourseBackup $edotCourseBackup)
    {
        $this->setLogUuid($request);
