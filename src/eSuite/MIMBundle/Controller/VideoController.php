...
class VideoController extends BaseController
{
    ...
    public function createVideoAction(Request $request, edotNotify $edotNotify)
    {
    ...
    public function updateVideoAction(Request $request, $videoId, edotNotify $edotNotify)
    {
        $this->setLogUuid($request);
    ...
    public function deleteVideoAction(Request $request, $videoId, edotNotify $edotNotify)
    {
        $this->setLogUuid($request);
