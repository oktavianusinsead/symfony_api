...
class GroupSessionController extends BaseController
{
    ...
    public function __construct(LoggerInterface $logger,
                                ...
                                AuthToken $authToken,
                                LoginManager $login,
                                public edotNotify $notify,
                                public edotCourseBackup $edotCourseBackup
                                )
    {
        ...
        $notify = new edotNotify($baseParameterBag, $logger);
        $edotCourseBackup = new edotCourseBackup($em, $baseParameterBag, $logger);
    }
    ...
    public function updateGroupSessionAction(Request $request, $groupSessionId)
    {
        ...
        if($groupSession->getSession()->getPublished() == TRUE) {
            ...
            $this->edotCourseBackup->updateCoursebackup($course);
        }
    ...
    private function checkGroupSessionAttachment(array $params) {
        ...
        $attachment_record = $this->doctrine
            ->getRepository('esuite\MIMBundle\Entity\\' . self::$ATTACHMENT_ENTITY_NAME)
            ->findOneBy($criterion);
