...
class LoginController extends BaseController
{
    ...
    public function ssoAdminAction(Request $request)
    {
        ...
        $session->set('sso_scope','edotadmin');
        return new RedirectResponse($request->getBaseUrl()."/sso/?sso_scope=edotadmin");
    }
    ...
    {
        $session = $request->getSession();
        $session->set('sso_scope','edotios');
        return new RedirectResponse($request->getBaseUrl()."/sso/?sso_scope=edotios");
    }
