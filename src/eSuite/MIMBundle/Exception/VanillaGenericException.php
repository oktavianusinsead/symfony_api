...
class VanillaGenericException extends \Exception implements MIMExceptionInterface
{
    ...
    public function __construct($statusCode = 500, $message = "")
    {
        ...
        $this->JSON_ERROR_MESSAGE = json_encode(
            ["errors" => ["vanilla" => [
                "There was an issue accessing Huddle. Please try again shortly. -- [$statusCode] - $message"
            ]]]
        );
    }
