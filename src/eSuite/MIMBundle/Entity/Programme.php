...
class Programme extends Base
{
     ...
     * @var boolean
     */
    #[ORM\Column(name: 'link_myesuite', type: 'boolean')]
    private $link_myesuite = FALSE;
     ...
     */
    #[ORM\Column(name: 'esuite_knowledge', type: 'boolean', nullable: true)]
    private $esuite_knowledge = FALSE;
     ...
     * Set link_myesuite
     *
     * @param boolean $linkMyesuite
     * @return Programme
     */
    public function setLinkMyesuite($linkMyesuite)
    {
        $this->link_myesuite = $linkMyesuite;
     ...
     * @return boolean
     */
    public function getLinkMyesuite()
    {
        return $this->link_myesuite;
    }
    ...
    /**
     * Set esuite_knowledge
     *
     * @param boolean $esuite_knowledge
     * @return Programme
     */
    public function setesuiteKnowledge($esuite_knowledge)
    {
        $this->esuite_knowledge = $esuite_knowledge;

        return $this;
    }

    /**
     * Get esuite_knowledge
     *
     * @return boolean
     */
    public function getesuiteKnowledge()
    {
        return $this->esuite_knowledge;
    }
    ...
    {
        return ($this->requestorScope == "edotsuper" || $this->requestorScope == "edotssvc");
    }
