...
class ProgrammeTest extends TestCase
{
    ...
    public function testWithLinkMyesuite()
    {
        $withLinkMyesuite = true;

        $this->assertEquals($withLinkMyesuite, $this->programme->setLinkMyesuite($withLinkMyesuite)->getLinkMyesuite());
    }

    public function testWithoutLinkMyesuite()
    {


        $withLinkMyesuite = false;
    ...
    public function testWithLinkesuiteKnowledge()
    {
        $withLinkesuiteKnowledge = true;

        $this->assertEquals($withLinkesuiteKnowledge, $this->programme->setesuiteKnowledge($withLinkesuiteKnowledge)->getesuiteKnowledge());
    }

    public function testWithoutLinkesuiteKnowledge()
    {
        $withLinkesuiteKnowledge = false;
    ...
    {
        $this->programme->setRequestorScope('edotsuper');
    ...
    public function testLatestUpdatedPersonTimestamp() {
        ...
        $esuiteStaff = new RoleMock();
        $esuiteStaff->setId( 849 );
        $esuiteStaff->setName('esuiteteam');
        ...
        $courseSubscription2->setRole($esuiteStaff);
