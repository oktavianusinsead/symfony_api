...
namespace esuite\MIMSeedFixturesBundle\DataFixtures\ORM;
...
class LoadRolesData implements FixtureInterface, ContainerAwareInterface
{
     ...
     *
     */
    private static string $ROLES_DATA_FILE = 'src/esuite/MIMSeedFixturesBundle/DataFixtures/ORM/data/Roles.json';
