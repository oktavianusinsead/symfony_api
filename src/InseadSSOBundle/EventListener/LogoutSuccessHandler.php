...
class LogoutSuccessHandler implements EventSubscriberInterface
{
    ...
    private function sendLogoutRequest()
    {
        ...
        if (count($sessions) < 1) {
            ...
            //https://study-api-dev72.insead.edu/api/v1.2/slologout?transientkey=87079f20783913ae6f635c3173a9a9338cb3578b2953de44891bcf272800c754b830b4ab
            ...
            $nameID = $session->getNameId();       //jefferson.martin@insead.edutest
            $nameIDFormat = $session->getNameIdFormat(); //urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified
            $samlLocation = $slo->getLocation();         //https://federation-uat.insead.edu/adfs/ls/
